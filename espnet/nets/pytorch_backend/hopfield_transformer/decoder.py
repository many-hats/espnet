...
from hopfield_layers.modules.transformer import HopfieldEncoderLayer
...
class Decoder(BatchScorerInterface, torch.nn.Module):
    ...
    def __init__(
        ...
        if selfattention_layer_type == "selfattn":
            ...
            logging.info("decoder self-attention layer type = hopfield layer")
            self.decoders = repeat(
                num_blocks,
                lambda lnum: HopfieldDecoderLayer(Hopfield(input_size=idim,num_heads=attention_heads,dropout=src_attention_dropout_rate,hidden_size=linear_units),Hopfield(input_size=idim,num_heads=attention_heads,dropout=src_attention_dropout_rate,hidden_size=linear_units)),
            )
