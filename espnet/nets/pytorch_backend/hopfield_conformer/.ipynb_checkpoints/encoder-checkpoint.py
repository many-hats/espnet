    ...
    def __init__(
        ...
        if selfattention_layer_type == "selfattn":
            ...
            self.encoders = repeat(
                num_blocks,
                lambda lnum: HopfieldEncoderLayer(Hopfield(attention_dim,num_heads=attention_heads,dropout=attention_dropout_rate)
                ),
            )
        ...
        if selfattention_layer_type != "hopfield":
            self.encoders = repeat(
                num_blocks,
